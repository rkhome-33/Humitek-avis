...
export default function Home() {
  ...
  const jsonLdFAQ = {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"Faites-vous de la recherche de fuites non destructive ?","acceptedAnswer":{"@type":"Answer","text":"Oui. Nous utilisons thermographie infrarouge, hygrométrie, caméras d’inspection, tests traceurs et mises en eau contrôlées."}},
      {"@type":"Question","name":"Intervenez-vous à Bordeaux et en Gironde ?","acceptedAnswer":{"@type":"Answer","text":"Oui, Bordeaux et toute la Nouvelle-Aquitaine."}},
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <Head>
        {/* BALISE GOOGLE TOUT EN HAUT */}
        <meta name="google-site-verification" content="9jHIglaVz3hm98knheFZeu22neWlcecT-mjcQOwbgiU" />
