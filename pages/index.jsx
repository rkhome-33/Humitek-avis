    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <Container className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative h-10 w-10">
              {/* ton logo redimensionné dans /public/logo_humitek.png */}
        ...
        <Container className="relative grid grid-cols-1 items-center gap-8 py-16 lg:grid-cols-2">
          <div className="text-white">
            ...
            <p className="mt-4 max-w-xl text-lg text-white/90">
              Experts indépendants — investigations instrumentées (thermographie, hygrométrie, inspection vidéo), analyses causales et recommandations de travaux (VMI, CTA, injections de résine, cuvelage).
            </p>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-700">
                Localisation <strong>non destructive</strong> par approche multi-instrumentale : thermographie IR,
                hygrométrie (capacitive / carbure), caméras d’inspection, tests traceurs, mise en eau contrôlée.
      ...
      <section id="avis" className="border-b border-slate-200 bg-white py-12">
        <Container>
          ...
          {/* 3 cartes de témoignages courts (texte statique SEO-friendly) */}
        ...
        <Container>
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-slate-600">
              Bordeaux – Nouvelle-Aquitaine. Dites-nous ce que vous constatez (<strong>humidité</strong>, <strong>VMI</strong>, <strong>CTA</strong>, <strong>infiltrations</strong>, <strong>fuite d’eau</strong>, <strong>injection</strong>, <strong>cuvelage</strong>), nous revenons vers vous rapidement.
            </p>
          </div>
      ...
      <footer className="border-t border-slate-200 bg-white py-10 text-sm text-slate-600">
        <Container className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">Envoie-moi ton URL Instagram quand tu l’as.</p>
          </div>
        </Container>
